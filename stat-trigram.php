...
<body>
    ...
    <script type="text/javascript">
        ...
        function show_frequent_words(){
            ...
            ajax_call("frequentTrigrams", [], [], [], 10, draw_frequent_words, calls, data_calls, spinner);
            ajax_call("frequentTrigrams", [], ["NEWS"], [], 10, draw_frequent_words, calls, data_calls, spinner);
            ajax_call("frequentTrigrams", [], ["ACADEMIC"], [], 10, draw_frequent_words, calls, data_calls, spinner);
            ajax_call("frequentTrigrams", [], ["CREATIVE"], [], 10, draw_frequent_words, calls, data_calls, spinner);
            ajax_call("frequentTrigrams", [], ["SPOKEN"], [], 10, draw_frequent_words, calls, data_calls, spinner);
            ajax_call("frequentTrigrams", [], ["GAZETTE"], [], 10, draw_frequent_words, calls, data_calls, spinner);
        }
        ...
        function show_word_time_category(){
            ...
            ajax_call("trigramCount", [], ["NEWS"], years, 0, draw_word_time_category, calls, data_calls, spinner);
            ajax_call("trigramCount", [], ["ACADEMIC"], years, 0, draw_word_time_category, calls, data_calls, spinner);
            ajax_call("trigramCount", [], ["CREATIVE"], years, 0, draw_word_time_category, calls, data_calls, spinner);
            ajax_call("trigramCount", [], ["SPOKEN"], years, 0, draw_word_time_category, calls, data_calls, spinner);
            ajax_call("trigramCount", [], ["GAZETTE"], years, 0, draw_word_time_category, calls, data_calls, spinner);
        }
        ...
        function show_composition() {
            ...
            data_calls = [];
            categories = ["NEWS","ACADEMIC","CREATIVE","SPOKEN","GAZETTE"];
            ajax_call("trigramCount", [], categories, [], 0, draw_composition, calls, data_calls, spinner);
            // (method, word, categories, years, amount, plot_func, calls, data_calls, spinner)
        }
        ...
        function show_time() {
            ...
            ajax_call("trigramCount", [], [], years, 0, draw_time, calls, data_calls, spinner);
            // (method, word, categories, years, amount, plot_func, calls, data_calls, spinner)
        }
