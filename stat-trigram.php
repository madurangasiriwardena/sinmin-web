...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Statistics - Trigram</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-8">
            ...
            <!-- <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default" id="frequent-words-table-div">
                        <div class="panel-heading">
                            <i class="fa fa-columns fa-fw"></i> Frequent Trigrams
                        </div>
                        <div class="panel-body sinmin-panel-body">
    ...
    <script type="text/javascript">
        ...
        function show_frequent_words(){
            ...
            ajax_call("frequentTrigrams", [], [], [], 10, draw_frequent_words, calls, data_calls, spinner, ajax_objs, cancel_ajax, show_frequent_words, "frequent-words-table-content");
            ajax_call("frequentTrigrams", [], ["NEWS"], [], 10, draw_frequent_words, calls, data_calls, spinner, ajax_objs, cancel_ajax, show_frequent_words, "frequent-words-table-content");
            ajax_call("frequentTrigrams", [], ["ACADEMIC"], [], 10, draw_frequent_words, calls, data_calls, spinner, ajax_objs, cancel_ajax, show_frequent_words, "frequent-words-table-content");
            ajax_call("frequentTrigrams", [], ["CREATIVE"], [], 10, draw_frequent_words, calls, data_calls, spinner, ajax_objs, cancel_ajax, show_frequent_words, "frequent-words-table-content");
            ajax_call("frequentTrigrams", [], ["SPOKEN"], [], 10, draw_frequent_words, calls, data_calls, spinner, ajax_objs, cancel_ajax, show_frequent_words, "frequent-words-table-content");
            ajax_call("frequentTrigrams", [], ["GAZETTE"], [], 10, draw_frequent_words, calls, data_calls, spinner, ajax_objs, cancel_ajax, show_frequent_words, "frequent-words-table-content");
        }
            ...
            for (i = 0; i < 10; i++) {
                ...
                for(j = 0; j< data_received.length; j++){
                    if(data_received[j].category == "all"){
                        if (data_received[j].value1[i] !== null && data_received[j].value2[i] !== null && data_received[j].value3[i] !== null){
                            row[1] = (data_received[j].value1[i].value).trim()+ " " + (data_received[j].value2[i].value).trim()+ " " + (data_received[j].value3[i].value).trim();
                        ...
                        if (data_received[j].value1[i] !== null && data_received[j].value2[i] !== null && data_received[j].value3[i] !== null){
                            row[3] = (data_received[j].value1[i].value).trim()+ " " + (data_received[j].value2[i].value).trim()+ " " + (data_received[j].value3[i].value).trim();
                        ...
                        if (data_received[j].value1[i] !== null && data_received[j].value2[i] !== null && data_received[j].value3[i] !== null){
                            row[5] = (data_received[j].value1[i].value).trim()+ " " + (data_received[j].value2[i].value).trim()+ " " + (data_received[j].value3[i].value).trim();
                        ...
                        if (data_received[j].value1[i] !== null && data_received[j].value2[i] !== null && data_received[j].value3[i] !== null){
                            row[7] = (data_received[j].value1[i].value).trim()+ " " + (data_received[j].value2[i].value).trim()+ " " + (data_received[j].value3[i].value).trim();
                        ...
                        if (data_received[j].value1[i] !== null && data_received[j].value2[i] !== null && data_received[j].value3[i] !== null){
                            row[9] = (data_received[j].value1[i].value).trim()+ " " + (data_received[j].value2[i].value).trim()+ " " + (data_received[j].value3[i].value).trim();
                        ...
                        if (data_received[j].value1[i] !== null && data_received[j].value2[i] !== null && data_received[j].value3[i] !== null){
                            row[11] = (data_received[j].value1[i].value).trim()+ " " + (data_received[j].value2[i].value).trim()+ " " + (data_received[j].value3[i].value).trim();
        ...
        function show_word_time_category(){
            ...
            ajax_call("trigramCount", [], ["NEWS"], years, 0, draw_word_time_category, calls, data_calls, spinner, ajax_objs, cancel_ajax, show_word_time_category, "words-time-category-chart");
            ajax_call("trigramCount", [], ["ACADEMIC"], years, 0, draw_word_time_category, calls, data_calls, spinner, ajax_objs, cancel_ajax, show_word_time_category, "words-time-category-chart");
            ajax_call("trigramCount", [], ["CREATIVE"], years, 0, draw_word_time_category, calls, data_calls, spinner, ajax_objs, cancel_ajax, show_word_time_category, "words-time-category-chart");
            ajax_call("trigramCount", [], ["SPOKEN"], years, 0, draw_word_time_category, calls, data_calls, spinner, ajax_objs, cancel_ajax, show_word_time_category, "words-time-category-chart");
            ajax_call("trigramCount", [], ["GAZETTE"], years, 0, draw_word_time_category, calls, data_calls, spinner, ajax_objs, cancel_ajax, show_word_time_category, "words-time-category-chart");
        }
        ...
        function show_composition() {
            ...
            ajax_call("trigramCount", [], categories, [], 0, draw_composition, calls, data_calls, spinner, ajax_objs, cancel_ajax, show_composition, "composition-chart");
            // (method, word, categories, years, amount, plot_func, calls, data_calls, spinner)
        }
        ...
        function show_time() {
            ...
            ajax_call("trigramCount", [], [], years, 0, draw_time, calls, data_calls, spinner, ajax_objs, cancel_ajax, show_time, "time-chart");
            // (method, word, categories, years, amount, plot_func, calls, data_calls, spinner)
        }
